...
# 下载 URL(安装程序主包)
# 这是主包的地址：千万不要搞错了
HA_WHEEL_URL="https://url.yh-iot.cloudns.org/https://github.com/yuanzhou029/xoai-core/releases/download/xoai-v2026.3.27.8/xoai-complete-wheels.zip"
